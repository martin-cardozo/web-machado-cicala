    ...
    <>
        ...
        <div className='about'>
            ...
            <section>
                ...
                <article>
                    <h2><strong>GABRIEL MACHADO  @machaditoarte</strong></h2>
                    <p>Gabriel Machado nació el 20 de agosto de 1966 en La Tablada, localidad de la Provincia de Buenos Aires. Es licenciado en publicidad, estudió en la Universidad de Lomas de Zamora. Durante la cursada, conoció a su compañero ideal y con quien comparte la pasión por la fotografía, José Cicala.</p>

                    <p>En 1993, crearon su propio estudio y con el tiempo, la experiencia de ambos junto con su popularidad abrió camino dentro del mundo artístico. Teatral, enérgico y optimista, Gabriel irradia luz no sólo por los flashes sino a través de su carisma. Esa personalidad encantadora y su disfrute, lo transmite en cada uno de los trabajos y es por eso que resulta ser el elegido por las celebrities. Cree en la belleza natural que esconde cada persona y logra descubrir esas nuevas facetas que quedan materializadas en imágenes.</p>
            ...
            <section>
                <article>
                    <h2><strong>JOSÉ CICALA @josecicala</strong></h2>
                    <p>José María Cicala nació el 15 de agosto de 1965 en Lanús, ciudad de la Provincia de Buenos Aires.  Es licenciado en publicidad, estudió en la Universidad de Lomas de Zamora. Durante la cursada, conoció a Gabriel Machado, su aliado perfecto y con quien comparte la pasión por la fotografía.</p>
                    ...
                    <p>Cinematográfico, teatral y pictórico, José Cicala fusiona la fotografía y la dirección de arte en piezas dignas de observar en detalle. El rubro publicitario, las mega-producciones, tanto fotográficas como audiovisuales, y los proyectos especiales resultan ser los medios indicados para generar contenidos que inspiran. Su creatividad combinada con la minuciosa dedicación que le presta a todos los procesos pre y post producción, componen imágenes que narran historias y crean personajes.</p>

                    <p>Coleccionista de épocas y devoto de objetos retro, José busca que el espectador deba mirar más de una vez para encontrarle múltiples sentidos a la foto. Ese empuje perfeccionista y su cualidad de “niño” fluyen en conjunto hacia ideas sumamente originales que aseguran la fidelidad del equipo con que trabaja.</p>
